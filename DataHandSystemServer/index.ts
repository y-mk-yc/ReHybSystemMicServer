...
import displaySetting from "./src/router/displaySetting";
...
// fs.writeFileSync('./files/initialPosition.json', JSON.stringify(initialPosition, null, 2), 'utf-8');
...
app.use('/model/setting', displaySetting);
// Define route
